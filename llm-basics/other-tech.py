def other_tech(text):
    """
    This is function with some examples suing other techniques for enhance text data quality for NLP models
    :param text:
    :return:
    """
    print("Original Text:")
    ...
    print("After Stripping Punctuation:")
    print(tokens)
    print("-" * 100)
    ...
    print("After Removing Numeric Tokens:")
    print(tokens)
...
text = "Apple released the iPhone! 15 I didn't know that Apple's announcement would shock everyone. Don't you think it's amazing?"
other_tech(text)